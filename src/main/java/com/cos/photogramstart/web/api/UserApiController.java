...
public class UserApiController {
	...
	public ResponseEntity<?>subscribe(@PathVariable int pageUserId,@AuthenticationPrincipal PrincipalDetails principalDetails){
	...
	public CMRespDto<?> update(
			...
			BindingResult bindingResult, //꼭 @Valid 가 적혀있는 다음 파라메터에 적어야 함.
			@AuthenticationPrincipal PrincipalDetails principalDetails){
